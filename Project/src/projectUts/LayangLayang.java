...
public class LayangLayang extends BangunDatar{
    ...
    LayangLayang(String namaBangunDatar, int banyakSudut, int banyakSisi,int simetriLipat, int simetriPutar) {
    ...
    void memilikiSimetriPutar() {
        System.out.println(getNama() + " tidak memiliki simetri putar");
    }
